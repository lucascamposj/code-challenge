...
public class CustomerIntegrationTest {
    ...
    public void getAll() {
        given().contentType(ContentType.JSON)
                ...
                .then().statusCode(200)
                .body("size()", equalTo(2))
                .body("id", hasItems("64b0834e-f350-4976-8a98-48ec117d72b1", "afff3cb4-c290-42c5-84f4-56ab644dcd1a"))
    ...
    void getByEmail() {
        given()
                .when()
                .get("/api/customer/search?email=second_user@email.com")
                .then()
    ...
    void getByEmail_NotFound() {
        given()
                .when()
                .get("/api/customer/search?email=not_found@email.com")
                .then()
                .statusCode(Response.Status.NOT_FOUND.getStatusCode());
    }
